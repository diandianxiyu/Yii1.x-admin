...
<div class="form-actions fluid">
    <div class="col-md-offset-3 col-md-9">
        <?php echo CHtml::link( '修改', Yii::app()->createUrl("adminis/department/update",array('id'=>$model['id'])),array('class' => "btn green")); ?>&nbsp;
<?php echo CHtml::link('返回列表',  Yii::app()->createUrl("adminis/department/index"), array('class' => "btn default")); ?>
