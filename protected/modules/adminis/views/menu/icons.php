...
<head>
	<meta charset="utf-8" />
	<title>图标选择 - <?php echo Yii::app()->name?></title>
				...
				<div class="col-md-12">
					<div class="tabbable tabbable-custom">
						<ul class="nav nav-tabs">
							...
							<li><a href="#tab_1_2" data-toggle="tab">Glyphicons</a></li>
						</ul>
						<div class="tab-content">
							<div class="tab-pane active fontawesome-demo" id="tab_1_1">
								<div class="note note-success">
									<p>
										...
										The complete set of 370 icons in Font Awesome 4.0.1
									</p>
								</div>
							...
							<div class="tab-pane glyphicons-demo" id="tab_1_2">
								<div class="note note-success">
									<p>
										Includes 180 glyphs in font format from the Glyphicon Halflings set. Glyphs scalable vector icons that can instantly be customized — size, color, drop shadow, and anything that can be done with the power of CSS.
									</p>
								</div>
								<ul class="list-unstyled1">
									...
									<li><span class="glyphicon glyphfa-ban"></span> .glyphicon .glyphfa-ban</li>
									...
									<li><span class="glyphicon glyphfa fa-clock-o"s""></span> .glyphicon .glyphfa fa-clock-o"s"</li>
									<li><span class="glyphicon glyphfa fa-clock-o"s"-circle"></span> .glyphicon .glyphfa fa-clock-o"s"-circle</li>
									<li><span class="glyphicon glyphfa fa-clock-o"s"-sign"></span> .glyphicon .glyphfa fa-clock-o"s"-sign</li>
