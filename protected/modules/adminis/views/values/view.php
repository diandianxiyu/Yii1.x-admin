<!-- BEGIN PAGE HEADER-->   
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-reorder"></i>属性</div>
							<div class="tools">
    ...
    <div class="form-group">
        <label class="control-label col-md-3"><?php echo CHtml::encode($lab['akey']) ?></label>
        <div class="col-md-4">
<?php echo CHtml::textField('akey', $model['akey'], array('size' => 60, 'maxlength' => 60, 'class' => 'form-control ' ,'disabled'=>true)); ?>

        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-md-3"><?php echo CHtml::encode($lab['avalues']) ?></label>
        <div class="col-md-4">
<?php echo CHtml::textField('avalues', $model['avalues'], array('size' => 60, 'maxlength' => 60, 'class' => 'form-control ' ,'disabled'=>true)); ?>
        </div>
    </div>
...
<div class="form-actions fluid">
    <div class="col-md-offset-3 col-md-9">
        <?php echo CHtml::link( '修改', Yii::app()->createUrl("adminis/values/update",array('id'=>$model['id'])),array('class' => "btn green")); ?>&nbsp;
<?php echo CHtml::link('返回列表',  Yii::app()->createUrl("adminis/values/index"), array('class' => "btn default")); ?>
