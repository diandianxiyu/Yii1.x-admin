<!-- BEGIN PAGE HEADER-->   
				...
				<div class="col-md-12">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-reorder"></i>图片</div>
							<div class="tools">
 ...
 <div class="form-group">
        <label class="control-label col-md-3">图片展示</label>
        <div class="col-md-4">
    ...
    <div class="form-group">
        <label class="control-label col-md-3"><?php echo CHtml::encode($lab['pic_path']) ?></label>
        <div class="col-md-4">
<?php echo CHtml::textField('pic_path', $model['pic_path'], array('size' => 60, 'maxlength' => 60, 'class' => 'form-control ' ,'disabled'=>true)); ?>

        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-md-3"><?php echo CHtml::encode($lab['text']) ?></label>
        <div class="col-md-4">
<?php echo CHtml::textField('text', $model['text'], array('size' => 60, 'maxlength' => 60, 'class' => 'form-control ' ,'disabled'=>true)); ?>
        </div>
    </div>
       <div class="form-group">
...
<div class="form-actions fluid">
    <div class="col-md-offset-3 col-md-9">
        <?php echo CHtml::link( '修改', Yii::app()->createUrl("adminis/slide/update",array('id'=>$model['id'])),array('class' => "btn green")); ?>&nbsp;
<?php echo CHtml::link('返回列表',  Yii::app()->createUrl("adminis/slide/index"), array('class' => "btn default")); ?>
