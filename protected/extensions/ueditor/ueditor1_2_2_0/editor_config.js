...
(function () {
    ...
    var tmp = window.location.pathname;
        URL = window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
           //  URL ="http://4a8d403b8fead009.tisumoon.com/ueditor1_2_2_0/";
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imageFieldName:"{yyyy}-{mm}-{dd}_{rand:4}_{filename}"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,fileFieldName:"{yyyy}-{mm}-{dd}_{rand:4}_{filename}"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数
