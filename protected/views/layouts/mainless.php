...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>SRBAC全局管理 - <?php echo Yii::app()->name; ?></title>
		<style type="text/css">
						...
						<table border="0" cellpadding="0" cellspacing="0" width="600px" style="height:100%;">
							<tr>
								<td align="left" valign="middle" style="padding-left:20px;">
									<a href="index.html">
									<img src="http://keenthemes.com/assets/img/emailtemplate/logo.png" width="86px" height="14px" alt="Metronic logo"/>
									</a>
								</td>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="600px" style="height:100%;">
							<tr>
								<td align="right" valign="middle" class="textwhite" style="font-size:12px;padding:20px;">
									...
									2014 &copy; <?php echo $this->_author ?> - <?php echo $this->_cmsName ?>.
								</td>
							</tr>
						</table>
					</center>
